...
POSTGRES_TABLE_NAME: Final = "indmoney_deposits_indmoney_statement"

# =========================
# Main loader
# =========================
def load_indmoney_deposits_from_indmoney_statement_transactions(
        indmoney_deposits_indmoney_statement_df: pd.DataFrame,
    ...
    ----------
    indmoney_deposits_indmoney_statement_df: pd.DataFrame
        Output dataframe from transform_indmoney_statement_to_get_indmoney_deposits
    get_write_engine
    ...
    None
    """
    logger.info("Starting indmoney deposits from indmoney statment loader")
    
    _loading_to_postgres(
        indmoney_deposits_indmoney_statement_df,
        POSTGRES_TABLE_NAME,
        get_write_engine,
        dry_run,
        run_mode,
