...
#=================================================================
# Can be moved to pipeline level helper
#=================================================================
def _derive_vest_statement_dates(
    ...
    current_statement_Previous_month_kast_date = last_day_prev_month_timestamp.strftime(POSTGRES_OUTPUT_DATE_FORMAT)

    return(
        current_statement_month_first_date,
        current_statement_month_last_date,
        current_statement_Previous_month_first_date,
        current_statement_Previous_month_kast_date,
    )
