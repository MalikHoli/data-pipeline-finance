...
from src.loaders.postgres.indmoney.indmoney_deposits_from_bank_statement_loader import load_indmoney_deposits_from_bank_statement_transactions
...
def run(
    ...
    bank_transactions_df = extract_bank_table_transactions(pdf_path,month_year)

    indmoney_deposits_from_bank_transactions_df = transform_bank_statement_to_get_indmoney_deposits(
        bank_transactions_df,
        month_year
    )

    load_indmoney_deposits_from_bank_statement_transactions(
        indmoney_deposits_from_bank_transactions_df,
        get_write_engine,
        dry_run,
        run_mode,
    ...
    logger.info("indmoney deposits from bank transactions pipeline finished successfully | Period: %s", month_year)        
